<template>
	<view>
		...
		<header>
			...
			<view style="margin:50px 0px 0 20px;">本网站已被<text style="color:red">{{this.amount}}</text>位小可耐使用! <br>
				<text style="color:springgreen">我曾如此渴望一路风霜能与你分享</text>
			</view>
		</header>
		<!-- 宫格 -->
		<uni-grid :column="3" :highlight="true" @change="change" :square="false">
			<uni-grid-item v-for="(item, index) in 6" :index="index" :key="index">
				<view class="grid-item-box gongge" style="background-color: #fff;height: 80px;">
					<!-- 特殊处理 -->
					<image src="../../static/image/log.png" style="width: 36px; height: 36px;"
						v-if="iconList[index]==='log'">
					</image>
		...
		<!-- 尾部 -->
		<footer>
			<span style="font-family:arial;">Copyright &copy;2022 tutu</span>
			<img src="" alt=""><a href="https://beian.miit.gov.cn/">鄂ICP备2022015608号-1</a>
			<a href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=42011502001544">
				鄂公网安备42011502001544号
			</a>
		...
		<view>
			<uni-popup ref="popup" type="center">
				<view class="pop">
					<img src="../../static/image/wx.png" mode=""></image>
					<img src="../../static/image/zfb.jpg" mode=""></image>
				</view>
			</uni-popup>
		</view>
		<view>
